...
wget http://radiohead.cnaf.infn.it:9999/view/REPOS/job/repo_storm_develop_SL5/lastSuccessfulBuild/artifact/storm_develop_sl5.repo -O /etc/yum.repos.d/storm_develop_sl5.repo
