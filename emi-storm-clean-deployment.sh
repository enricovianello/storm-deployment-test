...
extra_repo_filename=$(basename "$extra_repo")
extra_repo_extension="${extra_repo_filename##*.}"
...
configure_storm() {
execute "mkdir -p /etc/storm/siteinfo/vo.d"
execute "wget https://raw.github.com/enricovianello/storm-deployment-test/master/siteinfo/vo.d/dteam -O /etc/storm/siteinfo/vo.d/dteam"
execute "wget https://raw.github.com/enricovianello/storm-deployment-test/master/siteinfo/vo.d/testers.eu-emi.eu -O /etc/storm/siteinfo/vo.d/testers.eu-emi.eu"
execute "wget https://raw.github.com/enricovianello/storm-deployment-test/master/siteinfo/storm.def -O /etc/storm/siteinfo/storm.def"
execute "wget https://raw.github.com/enricovianello/storm-deployment-test/master/siteinfo/storm-users.conf -O /etc/storm/siteinfo/storm-users.conf"
execute "wget https://raw.github.com/enricovianello/storm-deployment-test/master/siteinfo/storm-groups.conf -O /etc/storm/siteinfo/storm-groups.conf"
execute "wget https://raw.github.com/enricovianello/storm-deployment-test/master/siteinfo/storm-wn-list.conf -O /etc/storm/siteinfo/storm-wn-list.conf"
