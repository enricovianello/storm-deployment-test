...
if [ $platform == "SL5" ]; then
	...
	epel_release="epel-release-6-7"
	epel_release_rpm="http://www.nic.funet.fi/pub/mirrors/fedora.redhat.com/pub/epel/6/x86_64/epel-release-6-7.noarch.rpm"
fi

# emi-release paths
emi_release="emi-release-2.0.0-1"
if [ $platform == "SL5" ]; then
	emi_release_rpm="$emi_release.sl5.noarch.rpm"
	emi_release_remote_rpm="http://emisoft.web.cern.ch/emisoft/dist/EMI/2/sl5/x86_64/base/$emi_release.sl5.noarch.rpm"
else
	emi_release_rpm="$emi_release.sl6.noarch.rpm"
	emi_release_remote_rpm="http://emisoft.web.cern.ch/emisoft/dist/EMI/2/sl6/x86_64/base/$emi_release.sl6.noarch.rpm"
fi
